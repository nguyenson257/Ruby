class Nguoi
  ...
  class CBGB
    ...
    def initialize
      cb1 = Nguoi.new("Nguyễn Hoàng", 23, "QN", "001", 1000000, 200000, 50000, 1150000)
      cb2 = Nguoi.new("Trần Thảo", 24, "DN", "002", 2000000, 200000, 50000, 2150000)
      cb3 = Nguoi.new("Linh Linh", 25, "QN", "003", 3000000, 200000, 50000, 3150000)
